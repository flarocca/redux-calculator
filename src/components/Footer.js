...
export default class Footer extends Component {
  render() {
    return (
      <div id='footer' className='container row footer'>
        <div className='container row full-width jc-center' style={{flexWrap: 'wrap'}}>
          <p className='text' style={{ textAlign: 'center', fontSize: 'small' }}>
